...
// ✅ NEW: landing-структура (під твій CourseDetailsPage.tsx)
export type CourseLanding = {
  hero?: {
    startLine?: LocalizedString;
    problemsTitle?: LocalizedString;
    problems?: LocalizedString[];
    goalTitle?: LocalizedString;
    goals?: LocalizedString[];
    notes?: LocalizedString[];
    modules?: LocalizedString[];
    liveLine?: LocalizedString;
  };
  ...
  forWho?: {
    ...
    thisIsForYouIfTitle?: LocalizedString;
    thisIsForYouIf?: LocalizedString[];
  };
...
export type Course = {
  ...
  /**
   * ✅ ВАЖЛИВО:
   * Тепер герой може бути або structured (course.landing.hero),
   * або старий текст (heroText) як fallback.
   */
  heroText?: LocalizedString;

  /**
   * ✅ NEW (optional) — structured landing content for the new page blocks
   */
...
export const l = (ru: string, ua: string, en: string): LocalizedString => ({
  ru,
  ua,
  en,
});
...
• After finishing the lessons, the curator will help you review and refine your own photos.`,
...

  {
    ...
    subtitle: l("На русском", "На російській", "In Russian"),
    ...
    shortDescription: l(
      ...
      "A color course to understand how it works, master pro techniques, and create attractive, premium-looking color using real student photos.",
    ),

    // ✅ NEW: структурні блоки під нову сторінку
    landing: {
      hero: {
        startLine: l(
          "Старт курса — 1-го декабря",
          "Старт курсу — 1-го грудня",
          "Course starts on December 1",
        ),
        ...
        problems: [
          l(
            "Фото выглядят блекло или наоборот — слишком насыщенно?",
            "Фото виглядають тьмяно або навпаки — занадто насичено?",
            "Photos look dull — or наоборот, too saturated?",
          ),
          l(
            "Двигаешь ползунки — а результат всё равно не тот?",
            "Рухаешь повзунки — а результат все одно “не той”?",
            "You move sliders, but the result still feels wrong?",
          ),
          l(
            "Цвета на экране и телефоне выглядят по-разному?",
            "Кольори на екрані та телефоні виглядають по-різному?",
            "Colors look different on your monitor vs your phone?",
          ),
          l(
            "Не получается добиться красивого, естественного оттенка кожи?",
            "Не виходить зробити красивий, природний відтінок шкіри?",
            "You can’t get natural, beautiful skin tones?",
          ),
          l(
            "Смотришь на фото на следующий день — и 🙈🙈🙈",
            "Дивишся на фото наступного дня — і 🙈🙈🙈",
            "You look at your edit the next day — and 🙈🙈🙈",
          ),
        ],

        goalTitle: l("Цель курса", "Мета курсу", "Course goal"),
        ...
        goals: [
          ...
          l(
            ...
            "Learn to create attractive, professional color using real student photos.",
          ),
        ],
      ...
      forWho: {
        ...
        bullets: [
          l(
            "Для ретушёров — начинающих и практикующих.",
            "Для ретушерів — початківців і практикуючих.",
            "For retouchers — beginners and working professionals.",
          ),
          l(
            "Для фотографов, которые хотят уверенно работать с цветом.",
            "Для фотографів, які хочуть впевнено працювати з кольором.",
            "For photographers who want to work with color confidently.",
          ),
          l(
            "И для тех, кто хочет понять, как устроен цвет.",
            "І для тих, хто хоче зрозуміти, як влаштований колір.",
            "And for anyone who wants to understand how color works.",
          ),
        ],

        thisIsForYouIfTitle: l(
        ...
        thisIsForYouIf: [
          l(
            "Оттенки кожи постоянно уходят в грязный.",
            "Відтінки шкіри постійно йдуть у “брудний”.",
            "Skin tones keep turning muddy or dirty.",
          ),
          l(
            "Двигаешь ползунки — а цвет всё равно не слушается.",
            "Рухаешь повзунки — а колір все одно “не слухається”.",
            "You move sliders, but color still won’t obey.",
          ),
          l(
            "После обработки фото выглядит неестественно.",
            "Після обробки фото виглядає неприродно.",
            "After editing, the photo looks unnatural.",
          ),
          l(
            "Не знаешь, что делать с цветом и с чего начать.",
            "Не знаєш, що робити з кольором і з чого почати.",
            "You don’t know where to start with color.",
          ),
        ],
      },

      learningProcess: {
        title: l("Процесс обучения", "Процес навчання", "Learning process"),

        steps: [
          {
            text: l(
              "Длительность курса — 1 месяц. 25 уроков + 3 прямых эфира.",
              "Тривалість курсу — 1 місяць. 25 уроків + 3 прямі ефіри.",
              "Course duration — 1 month. 25 lessons + 3 live sessions.",
            ),
          },
          {
            text: l(
              "После оплаты на вашу почту придёт письмо с инструкцией. Вам нужно будет написать в поддержку, чтобы уточнить данные и подтвердить запись на курс.",
              "Після оплати на вашу пошту прийде лист з інструкцією. Вам потрібно буде написати в підтримку, щоб уточнити дані та підтвердити запис на курс.",
              "After payment, you’ll receive an email with instructions. You’ll need to message support to confirm your details and enrollment.",
            ),
          },
          {
            text: l(
              "Курс состоит из 3-х модулей: • Теория цвета • Профессиональные техники цвета • Практика",
              "Курс складається з 3-х модулів: • Теорія кольору • Професійні техніки кольору • Практика",
              "The course has 3 modules: • Color theory • Pro color techniques • Practice",
            ),
          },
          {
            text: l(
              "Вы будете добавлены в закрытый чат в Telegram с уроками, домашними заданиями и советами.",
              "Вас додадуть у закритий чат у Telegram з уроками, домашніми завданнями та порадами.",
              "You’ll be added to a private Telegram chat with lessons, homework, and tips.",
            ),
          },
          {
            text: l(
              "Все уроки находятся в записи — вы сможете смотреть их в любое удобное для вас время.",
              "Усі уроки в записі — ви зможете дивитися їх у будь-який зручний час.",
              "All lessons are recorded — watch anytime that suits you.",
            ),
          },
          {
            text: l(
              "Новый урок открывается каждый день.",
              "Новий урок відкривається щодня.",
              "A new lesson unlocks every day.",
            ),
          },
          {
            text: l(
              "Прямые эфиры — одна из важнейших частей обучения. Участники могут отправлять фото для цветокоррекции в прямом эфире.",
              "Прямі ефіри — одна з найважливіших частин навчання. Учасники можуть надсилати фото для кольорокорекції в прямому ефірі.",
              "Live sessions are a key part of the course. Participants can submit photos for color grading during the live stream.",
            ),
          },
          {
            text: l(
              "Доступ ко всем материалам курса остаётся на протяжении 6 месяцев.",
              "Доступ до всіх матеріалів курсу зберігається протягом 6 місяців.",
              "Access to all course materials remains for 6 months.",
            ),
          },
        ],
      },
    ...
    // ✅ fallback (можеш лишити або потім прибрати)
    heroText: l(
      `У тебя проблемы с цветом?
...
Live sessions: color grading your photos.`,
    ...
    // ✅ Программа курса (залишаємо як у тебе)
    programSections: [
      {
        title: l(
          "🧩 Модуль 1 — Теория цвета",
        ...
        lessons: [
          l(
            "Понимание цвета с нуля. Как видеть, чувствовать и управлять цветом осознанно.",
            "Розуміння кольору з нуля. Як бачити, відчувати й керувати кольором усвідомлено.",
            "Color from scratch: how to see, feel, and control color intentionally.",
          ),
          ...
          l(
            ...
            "Колір для майстрів б’юті-індустрії",
      ...
      {
        title: l(
          "⚙️ Модуль 2 — Профессиональные техники цвета",
          "⚙️ Модуль 2 — Професійні техніки кольору",
          "⚙️ Module 2 — Pro color techniques",
        ),
        lessons: [
          l(
            "Погружаемся в практику и реальные инструменты работы с цветом.",
            "Занурюємось у практику та реальні інструменти роботи з кольором.",
            "Deep dive into practice and real tools for working with color.",
          ),
          l(
            "Профессиональные техники Цвета – ч.1",
            "Професійні техніки кольору — ч.1",
            "Pro color techniques — part 1",
          ),
          l(
            "Профессиональные техники Цвета – ч.2",
            "Професійні техніки кольору — ч.2",
            "Pro color techniques — part 2",
          ),
          l(
            "Профессиональные техники Цвета – ч.3",
            "Професійні техніки кольору — ч.3",
      ...
      },
      {
        ...
        lessons: [
          l(
            "Закрепляем всё на реальных кадрах, разбираем ваши работы и делаем результат.",
            "Закріплюємо все на реальних кадрах, розбираємо ваші роботи й отримуємо результат.",
            "We lock it in with real shots: review your work and deliver results.",
          ),
          l("Прямой эфир", "Прямий ефір", "Live session"),
          l("Практика на фото", "Практика на фото", "Practice on photos"),
          l("Практика на фото", "Практика на фото", "Practice on photos"),
...
• 25% discount on Viktor’s products (1 year)`,
  ...
  },
  {
    ...
    title: l("Ретушь ногтей (EN)", "Ретуш нігтів (EN)", "Nail Retouching (EN)"),
    ...
    heroText: l(
      `Этот курс создан специально для nail-мастеров.

📸 Зачем нужна ретушь?
Профессиональные фото:
• делают ваши работы визуально дороже
• привлекают больше клиентов
• повышают доверие
• позволяют повышать цены

Клиенты выбирают глазами.

Курс создан совместно с топ nail-мастерами:
• без лишней информации
• без сложных терминов
• без «страшного Photoshop»

🎯 Цель курса (5–10 минут на фото):
• создавать коммерческие фото ногтей
• собрать продающее портфолио
• стабильно делать контент для соцсетей

Вы научитесь:
• самостоятельно ретушировать ногти
• создавать портфолио, которое продаёт
• делать контент для роста дохода`,
      `Цей курс створений спеціально для nail-майстрів.

📸 Навіщо потрібна ретуш?
Професійні фото:
• роблять роботи візуально дорожчими
• приваблюють більше клієнтів
• підвищують довіру
• дозволяють піднімати ціни

Клієнти обирають очима.

Курс створений разом із топ nail-майстрами:
• без зайвої інформації
• без складних термінів
• без «страшного Photoshop»

🎯 Мета курсу (5–10 хвилин на фото):
• створювати комерційні фото нігтів
• зібрати портфоліо, яке продає
• регулярно робити контент для соцмереж

Ви навчитеся:
• самостійно ретушувати нігті
• створювати портфоліо для клієнтів
• робити контент для росту доходу`,
      `This course is created exclusively for nail stylists.

📸 Why do you need retouching?
Professional photos:
• make your work look more premium
• attract more clients
• increase trust
• allow you to raise your prices

Clients choose with their eyes.

The course is developed with top nail artists:
• no unnecessary information
• no complicated terminology
• no “scary Photoshop”

🎯 Course goal (5–10 minutes per photo):
• create high-quality commercial nail photos
...
• make content for promotion and income growth`,
    ...
    infoRows: [
      {
        labelKey: "course.info.learningStatus",
        value: l("Доступен", "Доступний", "Available"),
      },
      {
        labelKey: "course.info.startDate",
        value: l(
      ...
      {
        labelKey: "course.info.access",
        value: l("6 месяцев", "6 місяців", "6 months"),
      },
      {
        labelKey: "course.info.lessonDuration",
        value: l("15–25 минут", "15–25 хвилин", "15–25 minutes"),
      },
      {
        labelKey: "course.info.software",
        value: l("Photoshop", "Photoshop", "Photoshop"),
      ...
      {
        labelKey: "course.info.devices",
        value: l("Любые устройства", "Будь-які пристрої", "Any device"),
      },
      {
        labelKey: "course.info.watchAnytime",
        value: l("В любое время", "У будь-який час", "Anytime"),
      },
    ],
    ...
    tariffs: [
      {
        ...
        price: "49$",
        include: [1, 2, 3, 4],
        paymentUrl: "https://www.viktorkyslyi.com/checkout/?add-to-cart=9920",
      },
      {
        title: l(
          "Курс + поддержка куратора",
        ...
        price: "149$",
        include: [1, 2, 3, 4, 5],
        paymentUrl: "https://www.viktorkyslyi.com/checkout/?add-to-cart=9922",
        detailsTitle: l(
          "Как работает поддержка?",
          "Як працює підтримка?",
          "How does curator support work?",
